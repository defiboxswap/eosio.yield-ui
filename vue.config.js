...
let proxyEnv = {
  ...
  // 代理控制
  "/api/usn/": {
    target: `http://${process.env.VUE_APP_BASEURL}:${process.env.VUE_APP_PORT22}`,
    // target: 'https://defibox.io',
    ws: false,
    changeOrigin: true,
    pathRewrite: {
  ...
  "/api/bal/": {
    target: `http://${process.env.VUE_APP_BASEURL}:${process.env.VUE_APP_PORT28}`,
    ws: false,
    changeOrigin: true,
  },
  "/api/common/": {
  ...
  "/api/lend/": {
    target: `http://${process.env.VUE_APP_BASEURL}:${process.env.VUE_APP_PORT26}`,
    // target: 'https://defibox.io',
    ws: false,
    changeOrigin: true,
  },
  ...
  "/api/webcommon/": {
    target: `http://${process.env.VUE_APP_BASEURL2}:${process.env.VUE_APP_PORT27}`,
    ws: false,
    changeOrigin: true,
  },
  "/sys": {
    target: `http://${process.env.VUE_APP_BASEURL2}:${process.env.VUE_APP_PORT22}`,
    ws: false,
    changeOrigin: true,
  },
  "/api": {
    target: `http://${process.env.VUE_APP_BASEURL}:${process.env.VUE_APP_PORT21}`,
    //target: `https://defibox.io/`,
    ws: false,
    changeOrigin: true,
  },
  "/cpu": {
    target: `http://${process.env.VUE_APP_BASEURL}:${process.env.VUE_APP_PORT2}`,
    //target: `https://defibox.io/`,
    ws: false,
    changeOrigin: true,
  },
