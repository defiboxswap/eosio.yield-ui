...
export const wallets = [
  ...
  },
  {
    ...
    download: "http://www.medishares.org/",
    options: {},
    version: "1.6.5",
    status: 1,
    active: null,
  ...
  },
  {
    name: "wombat",
    key: "wombat",
    url: "/static/img/wallet/wombat.png?v=1",
    logo: "/static/img/wallet/w/wombat.png?v=1",
    download: "https://getwombat.io/",
    options: {},
    version: "Android 5.0、 iOS 12",
    status: 1,
    active: null,
  },
]
...
const defaulURl = "/static/img/vip"
const levels = [
  {
    name: "0级VIP", // level name
    key: 0, // Wallet callback name (matching logo)
    viplogo: `${defaulURl}/VIP.png`, // Little Logo
  },
  {
    name: "1级VIP",
    key: 1,
    viplogo: `${defaulURl}/VIP-1.png`,
  },
  {
    name: "2级VIP",
    key: 2,
    viplogo: `${defaulURl}/VIP-2.png`,
  },
  {
    name: "3级VIP",
    key: 3,
    viplogo: `${defaulURl}/VIP-3.png`,
  },
  {
    name: "4级VIP",
    key: 4,
    viplogo: `${defaulURl}/VIP-4.png`,
  },
  {
    name: "5级VIP",
    key: 5,
    viplogo: `${defaulURl}/VIP-5.png`,
  },
  {
    name: "6级VIP",
    key: 6,
    viplogo: `${defaulURl}/VIP-6.png`,
  },
  {
    name: "7级VIP",
    key: 7,
    viplogo: `${defaulURl}/VIP-7.png`,
  },
  {
    name: "8级VIP",
    key: 8,
    viplogo: `${defaulURl}/VIP-8.png`,
  },
  {
    name: "9级VIP",
    key: 9,
    viplogo: `${defaulURl}/VIP-9.png`,
  },
  {
    name: "10级VIP",
    key: 10,
    viplogo: `${defaulURl}/VIP-10.png`,
  },
]

export function vipLogo(memberLevel, way) {
  const info = store.state.app.accountInfo
  let level = null
  if (info && info.level) {
    level = info.level
  }
  if (memberLevel || (memberLevel === 0 && way === "NDX")) {
    level = memberLevel
  }
  const item = levels.find((v) => v.key.toString() === level.toString())
  if (item) {
    return item.viplogo
  }
  return "/static/img/VIP.png?v=1.0.0"
}
...
const desktopWallets = {
  ...
  LeafWallet: {
    name: "LeafWallet",
    svgUrl: "/static/img/leaf.svg",
    logo: "/static/img/wallet/plug/LeafWallet-2.png?v=1",
    logo1: "/static/img/wallet/plug/leaf.png?v=3",
  ...
  TronLink: {
    name: "TronLink",
    logo: "/static/img/wallet/plug/tron.png",
  ...
  Metahub: {
    name: "Metahub",
    svgUrl: "/static/img/metahub.jpg",
    download: "https://metahub.cash",
    helpCenter: {
      "zh-CN": "https://support.newdex.net/hc/zh-cn/articles/360028369552-%E5%A6%82%E4%BD%95%E4%BD%BF%E7%94%A8%E5%8F%B6%E5%AD%90%E9%92%B1%E5%8C%85%E6%B5%8F%E8%A7%88%E5%99%A8%E6%8F%92%E4%BB%B6%E7%89%88",
      "zh-TW": "https://support.newdex.net/hc/zh-tw/articles/360028369552-%E5%A6%82%E4%BD%95%E4%BD%BF%E7%94%A8%E8%91%89%E5%AD%90%E9%8C%A2%E5%8C%85%E7%80%8F%E8%A6%BD%E5%99%A8%E6%8F%92%E4%BB%B6%E7%89%88",
      en: "https://support.newdex.net/hc/en-us/articles/360028369552-How-to-Use-Leaf-Wallet-Browser-Plug-in-Version-",
...
export const walletsPlug = {
  ...
  MEETONE: [desktopWallets.LeafWallet, desktopWallets.Scatter, desktopWallets.MathWallet],
  ENU: [desktopWallets.Ironman],
  FIBOS: [desktopWallets.Ironman],
  TELOS: [desktopWallets.LeafWallet, desktopWallets.Scatter, desktopWallets.MathWallet, desktopWallets.womba],
  TRON: [desktopWallets.TronLink, desktopWallets.MathWallet],
  WAX: [
    // desktopWallets.LeafWallet,
    desktopWallets.Scatter,
    desktopWallets.TokenPocket,
  ...
  LYNX: [desktopWallets.LeafWallet, desktopWallets.Scatter],
}
